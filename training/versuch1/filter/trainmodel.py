...
training_data_path = data_directory + "training.csv"
test_data_path = data_directory + "test.csv"
validation_data_path = data_directory + "validation.csv"
...
def get_x_y(dataset, encoded_features):
	matching = np.array(dataset["matching"])
...
template_words_convolutional_kernel_size = 4
basic_words_convolutional_kernel_size = 2
template_words_convolutional_count = 48
basic_words_convolutional_count = 48
        
template_words_second_convolutional = True
basic_words_second_convolutional = False

        
template_words_second_convolutional_kernel_size = 4
template_words_second_convolutional_count = 24
        
basic_words_second_convolutional_kernel_size = 8
basic_words_second_convolutional_count = 16
...
template_char_second_convolutional = True
basic_char_second_convolutional = False

template_char_convolutional_kernel_size = 6
basic_char_convolutional_kernel_size = 10
template_char_convolutional_count = 16
basic_char_convolutional_count = 32
        

template_char_second_convolutional_kernel_size = 2
template_char_second_convolutional_count = 32
        

basic_char_second_convolutional_kernel_size = 4
basic_char_second_convolutional_count = 32
...
layer_basic_words = layers.Dense(256, activation='relu')(layer_basic_words)
...
layer_basic_char = layers.Dense(256, activation='relu')(layer_basic_char)
...
model.compile(
    ...
    metrics=['accuracy', metrics.Precision(), metrics.Recall(), metrics.AUC(curve='PR', name='AUPRC')])
# print(model.summary())
print("plotting")
plot_model(
	model,
...
checkpoint_filepath = model_checkpoint_directory + 'trainmodel_weights.{epoch:02d}-{' + metrics[4] + ':.2f}.h5'

keras_callbacks =[keras.callbacks.ModelCheckpoint(filepath=checkpoint_filepath)]
history = model.fit(x = x_train, y=y_train, callbacks=keras_callbacks,  batch_size=32, epochs=20, validation_data=(x_validation, y_validation), verbose=2)
