...
def getStructureLayer(inputName, shape_x):
  ...
  structure_layer_dense = layers.Dense(24, activation='tanh', kernel_regularizer=keras.regularizers.l2(l=0.001))(input_structure)
...
def make_model():
  ...
  layer_structure_template_8 = layers.Dense(24, activation='tanh', kernel_regularizer=keras.regularizers.l2(l=0.001))(input_structure_template_8)
  ...
  layer_structure_dense = layers.Dense(128, activation='tanh', kernel_regularizer=keras.regularizers.l2(l=0.001))(layer_structure_dense)
  layer_structure_dense = layers.Dense(64, activation='tanh', kernel_regularizer=keras.regularizers.l2(l=0.001))(layer_structure_dense)
  ...
  layersCategories = layers.Dense(8, activation='tanh', kernel_regularizer=keras.regularizers.l2(l=0.001))(inputCategories)
  ...
  x = layers.Dense(32, activation='tanh', kernel_regularizer=keras.regularizers.l2(l=0.001))(x)
