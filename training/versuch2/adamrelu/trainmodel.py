...
def getStructureLayer(inputName, shape_x):
  ...
  structure_layer = layers.Conv1D(filters=2, kernel_size=3, activation='relu')(structure_layer)
  structure_layer = layers.Flatten()(structure_layer)	
  structure_layer = layers.Dropout(0.2)(structure_layer)

  structure_layer_dense = layers.Dense(24, activation='relu')(input_structure)
...
def make_model():
  ...
  layer_structures = layers.Dense(24, activation='relu')(layer_structures)

  input_structure_template_8 = keras.Input(shape=(45,), name='inputStructureTemplate08')
  layer_structure_template_8 = layers.Dense(24, activation='relu')(input_structure_template_8)
  ...
  layer_structure_dense = layers.Dense(128, activation='relu')(layer_structure_dense)
  layer_structure_dense = layers.Dense(64, activation='relu')(layer_structure_dense)
  ...
  layer_structures = layers.Dense(32, activation='relu')(layer_structures)
  layer_structures = layers.Dropout(0.2)(layer_structures)

  inputCategories = keras.Input(shape=(20,), name='categories')
  layersCategories = layers.Dense(8, activation='relu')(inputCategories)
